            ...
            <td class="date-box" width="24%">
                <div>
                    <div>
                        ...
                        <span class="span-date"><?php echo date('M, Y', strtotime($deduction[0]->created_on)) ?></span>
    ...
    <table width=100% id="customers">
        <thead>
            <tr>
                ...
                <th class="text-center cols3" style="text-align:center" colspan="4">
        ...
        <tbody>
            ...
            $temployee = $temployer = $ttotal = $tGross = 0;
            foreach ($deduction as $key => $value) {
                ...
                if($value->is_vacation == 1){
                    $vacationAmount = $value->empYtd['vacation'];
                }
                $gross          = $value->empYtd['reg_amt'] + $value->empYtd['stat_amt'] + $value->empYtd['wages'] + $value->empYtd['miscellaneous'] + $value->empYtd['medical_contribution'] + $vacationAmount; 

                $temployee  += $empDeduction;
                $temployer  += $emprDeduction;
                $ttotal     += $totalDeduction;
                $tGross     += round($gross, 2);
            ...
            <tr>
                ...
                <th class="text-right"><?php echo number_format(round($tGross, 2), 2) ?></th>
