...
<body style="background-gradient: linear #88FFFF #FFFF44 0 0.5 1 0.5;">
    <table class="header"  style="background-color:#fbfbfb">
        <tr>
    ...
    <table class="top-detail border">
        <thead>
            <tr class="border" style="background-color:#c6d9f0">
                <th class="border" >Employee Name / Address</th>
                <th class="border" >Reporting Period</th>
                <th class="border" >Pay Date</th>
                <th class="border" >Employee Id #</th>
            </tr>
        </thead>
        <tbody>
            <tr class="border" style="background-color:#dde4f1">
                <td class="border">Faria Abbas <br> dsfsdf, koramangala bangalore, G5g5g5</td>
                <td class="border">11-01-202 - 20-01-2020</td>
                <td class="border">11-01-2020</td>
    ...
    <table class="earning-detail border">
        <thead>
            <tr class="border" style="background-color:#fae4d5">
        ...
        <tbody >
            <tr style="background-color:#dde4f1">
                <td>REGULAR</td>
