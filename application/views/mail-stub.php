						...
						<form action="<?php echo site_url('main_control/save_payroll'); ?>" method="post">
							...
							<table class="table ">
								<tr class="table-active table-border-double">
									...
									<td class="text-right">
										<button class=" btn small-btn btn-success" id="print" type="button">Print</button>
									</td>
	...
	<script>
		$(document).ready(function() {
			...
			$('#print').click(function(e) {
				...
				var dates = $('#dates').val();
				window.open("<?= base_url() ?>" + 'payroll?print=true&company=' + companySelect + '&sdate=' + dates.split(' to ')[0] + '&edate=' + dates.split(' to ')[1]);
			});
		});
