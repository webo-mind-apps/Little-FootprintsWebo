				...
				<div class="card">
					<div class="card-header header-elements-inline">
						<h6 class="card-title payslip_heading">Employee master<br><br>
							<a href="<?php echo base_url(); ?>main/employee_details_fetch/#search" style="background-color:#3b579d;padding:10px;color:#fff;"><i class="fa fa-search"></i> Search</a>
						</h6>
					...
					?>
					<form method="post" id="frm" action="<?php echo base_url(); ?>main/employee_details_insert_update">
						<div class="card-body">
							<div class="row">
								<div class="col-sm-5">
